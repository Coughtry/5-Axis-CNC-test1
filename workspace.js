...
cprequire_test(["inline:com-chilipeppr-workspace-test2"], function(ws) {
    ...
    $('title').html("test2 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-test2", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-test2", // Make the id the same as the cpdefine id
        name: "Workspace / test2", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace test2.`,
